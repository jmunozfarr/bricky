...
type DetailState =
  { kind: "loading" } | { kind: "ready"; data: PartDetail } | { kind: "error"; message: string };
  ...
  if (detail.kind === "error") {
    return (
      <div className="error" role="alert">
        <strong>Part request failed.</strong>
  ...
  return (
    <section className="part-inspector">
      ...
      <dl className="part-metadata">
        <div>
          <dt>Part ID</dt>
          <dd>{detail.data.partId}</dd>
        </div>
        <div>
          <dt>Category</dt>
          <dd>{detail.data.category}</dd>
        </div>
        <div>
          <dt>Author</dt>
          <dd>{detail.data.author ?? "Unknown"}</dd>
        </div>
        <div>
          <dt>Classification</dt>
          <dd>{detail.data.orgClassification ?? "Not specified"}</dd>
        </div>
        <div>
          <dt>License</dt>
          <dd>{detail.data.license ?? "See upstream file"}</dd>
        </div>
      </dl>
